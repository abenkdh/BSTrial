...
package uc.benkkstudio.bstrial;
 ...
 * app.
 */
public class BSTrial {

    /**
     * The default duration of a trial period in days.
     */
    private static final int DEFAULT_TRIAL_DURATION_IN_DAYS = 3;
     ...
     */
    public BSTrial(Context context, Config config) {
    ...
    /**
     * Configuration for a {@link BSTrial}.
     * <p>
     * If you overwrite nothing, you will get a trial that lasts
     * {@value BSTrial#DEFAULT_TRIAL_DURATION_IN_DAYS} days and
     * that uses the
