...
public class BSTrialTest {
    ...
    public void oldTimestampMustCauseTrialToBeOver() {
        ...
        BSTrial trial = new BSTrial(context, new BSTrial.Config().factors(factor));
    ...
    public void availableFactorSupersedesNotAvailableOne() {
        ...
        new BSTrial(context, new BSTrial.Config().factors(factor, factor2));
